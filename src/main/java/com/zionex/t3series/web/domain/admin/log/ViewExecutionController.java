...
public class ViewExecutionController {
    ...
    public List<ViewExecution> getViewExecutionLog(@RequestParam("start-date") @DateTimeFormat(pattern = DATE_PATTERN) LocalDate startDate,
                                                   @RequestParam("end-date") @DateTimeFormat(pattern = DATE_PATTERN) LocalDate endDate,
                                                   @RequestParam(value = "menu-cd", required = false) String menuCd,
                                                   @RequestParam(value = "menu-nm", required = false) String menuNm,
