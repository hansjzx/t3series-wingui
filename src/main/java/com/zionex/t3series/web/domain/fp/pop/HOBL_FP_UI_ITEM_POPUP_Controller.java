...
@RestController
@AllArgsConstructor
public class HOBL_FP_UI_ITEM_POPUP_Controller {

    private final QueryHandler queryHandler;
	
    // 일정 조회
    // @PostMapping("/fp/co/HOBL_FP_UI_ITEM_POPUP/q1")
    @RequestMapping("/fp/co/HOBL_FP_UI_ITEM_POPUP/q1")
    public List<Map<String, Object>> getData1(@RequestBody Map<String, Object> params, HttpServletRequest request) {
        ...
        return queryHandler.getList("SP_HO_UI_ITEM_POPUP_MST_Q01", param);
    }
}
