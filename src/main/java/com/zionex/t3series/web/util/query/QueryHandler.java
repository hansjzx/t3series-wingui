...
public class QueryHandler {
    ...
    public Map<String, Object> save(String procName, Map<String, Object> params) {
        ...
        if (!ObjectUtil.toBoolean(result.get("success"))) {
    ...
    public Map<String, Object> checkResultFlag(List<Map<String, Object>> result) {
        ...
        if (result.isEmpty()) {
            ...
            rt.put("success", ObjectUtil.toString(resultMap.get("P_RT_ROLLBACK_FLAG")));
            rt.put("message", ObjectUtil.toString(resultMap.get("P_RT_MSG")));
        }
