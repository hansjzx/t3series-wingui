...
import {
  ...
  BaseGrid, InputField, GridAddRowButton, GridSaveButton, GridDeleteRowButton, useViewStore, useIconStyles, zAxios,
...
function MenuBadge() {
  ...
  function loadData() {
    ...
    zAxios.get(baseURI() + 'system/menus/badges/general', {
      params: {
