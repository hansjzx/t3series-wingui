      ...
      <ResultArea sizes={[30, 30, 40]} direction={"vertical"}>
        ...
        <Box >
          <ButtonArea title={transLangKey('LICENSE_KEY_INFO')}>
            <LeftButtonArea></LeftButtonArea>
            <RightButtonArea>
              <Tooltip title={transLangKey("LICENSE_KEY_CREATION")} placement='bottom' arrow>
                <Button variant="outlined" endIcon={<ArrowCircleDownIcon />} color="success" onClick={() => { getServerLicenseInfo() }}>{transLangKey('LICENSE_KEY_CREATION')}</Button>
              </Tooltip>
            </RightButtonArea>
          </ButtonArea>
