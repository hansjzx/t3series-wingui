...
function PopSelectUser(props) {
  ...
  const popupLoadData = () => {
    ...
    zAxios.get(baseURI() + 'system/users/' + props.groupCode + '/except', {
      params: {
  ...
  return (
    <PopupDialog open={props.open} onClose={props.onClose} onSubmit={handleSubmit(saveSubmit, onError)} checks={[userSelectGrid]} title={transLangKey("ADD_USER")} resizeHeight={400} resizeWidth={770}>
      <Box>
