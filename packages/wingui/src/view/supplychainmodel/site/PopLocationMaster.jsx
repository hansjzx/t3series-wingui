...
let popupGrid1Items = [
  ...
  { name: "CORPOR_NM", dataType: "text", headerText: "CORPOR_NM", visible: true, editable: false, width: "100" },
  ...
  { name: "LOCAT_LV_DESCRIP", dataType: "text", headerText: "LOCAT_LV_DESCRIP", visible: true, editable: false, width: "100", textAlignment: "center" },
...
function PopLocationMaster(props) {
...
export default PopLocationMaster;
