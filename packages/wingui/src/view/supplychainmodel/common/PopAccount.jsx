...
let popupGridItems = [
  ...
  { name: 'ACCOUNT_CD', dataType: 'text', headerText: 'ACCOUNT_CD', visible: true, editable: false, width: '150' },
...
function PopAccount(props) {
  ...
  return (
    <PopupDialog open={props.open} onClose={props.onClose} onSubmit={handleSubmit(saveSubmit, onError)} title="POP_UI_IM_13_04" resizeHeight={600} resizeWidth={600}>
