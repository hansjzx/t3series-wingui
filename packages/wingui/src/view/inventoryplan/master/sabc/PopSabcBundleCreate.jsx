...
function PopSabcBundleCreate(props) {
  ...
  function saveSubmit() {
    ...
    formData.append('CURRENT_OPERATION_CALL_ID', 'OPC_POP_UI_IM_08_03_WINDOW_01_CPT_99_01_CLICK_01');

    zAxios.post(baseURI() + 'engine/mp/SRV_UI_IM_08_BATCH',
    formData,
    {
      headers: {
  ...
  return (
    <>
    <PopupDialog open={props.open} onClose={props.onClose} onSubmit={handleSubmit(saveSubmit, onError)} title='POP_UI_IM_08_03' resizeHeight={230} resizeWidth={400}>
      <Box style={{height:'100%'}}>
        <InputField type='radio'  name='APPLY_POINT_CD'  control={control}  setValue={setValue}  options={options1} />
        <InputField type='check'  name='OVERWRITE_DATA_YN' control={control} wrapStyle={{width: '360px'}} labelStyle={{width: '220px', maxWidth: '220px'}}
...
export default PopSabcBundleCreate;
