...
function PopItemResCapacityBundleCreate(props) {
  ...
  function saveSubmit() {
    ...
    zAxios({
      method: 'post',
      url: baseURI() + 'engine/mp/SRV_UI_MP_09_BATCH',
      data: formData,
      fromPopup: true
    })
      .then(function (res) {
        const msg = res.data.RESULT_DATA.IM_DATA.SP_UI_MP_09_BATCH_P_RT_MSG;
  ...
  return (
    <>
    <PopupDialog open={props.open} onClose={props.onClose} onSubmit={handleSubmit(saveSubmit, onError)} title="POP_UI_MP_09_05" resizeHeight={720} resizeWidth={500}>
...
export default PopItemResCapacityBundleCreate;
