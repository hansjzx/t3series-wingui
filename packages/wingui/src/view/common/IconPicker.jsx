...
import { PopupDialog, useInputStyles } from "@zionex/wingui-core/src/common/imports";
  ...
  return (
    <PopupDialog type="NOBUTTONS" open={props.open} onClose={props.onClose} title={transLangKey("SELECT_ICON")} checks={[]} resizeHeight={770} resizeWidth={400}>
      <Box className={classes.inputDiv}>
        <TextField id="iconNm" inputType="labelText" variant="outlined" InputProps={{ readOnly: false, }} value={iconName} onChange={handleChange} size="small" />
      </Box>
