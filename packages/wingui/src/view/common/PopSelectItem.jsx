...
import { SearchArea, InputField, BaseGrid, useViewStore, zAxios } from "@zionex/wingui-core/src/common/imports";
...
function PopSelectItem(props) {
  ...
  const loadPopupItem = (data) => {
    ...
    param.append("ITEM_LV_CD", data.itemLvCd === "ALL" ? "" : data.itemLvCd);
